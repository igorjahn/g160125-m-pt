...
# 1. Напишите функцию `sum_list(lst)`,
# которая возвращает сумму всех элементов
# списка `lst` с помощью рекурсии.
...
# 2. Напишите функцию `reverse_string(s)`,
# которая возвращает строку `s` в обратном порядке с помощью рекурсии.
# Пример использования:
...
# 3. Напишите функцию `list_length(lst)`, которая
# возвращает длину списка `lst` с помощью рекурсии.
# Пример использования:
